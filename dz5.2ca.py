...
def player_vs_player():
    ...
    print(f'\n  {player_1} и  {player_2} вступили в бой !\n')
    ...
    while candies_total > 0:
        if count == 0:
            ...
            if step > candies_total or step > max_take:
                step = int(input(
                    f'\n сликом много ограничение {max_take} конфет {lucky}, попробуй еще раз: '))
        ...
        if count == 1:
            ...
            if step > candies_total or step > max_take:
                step = int(input(
                    f'\nсликом много ограничение  {max_take} конфет {loser}, попробуй еще раз: '))
            candies_total = candies_total - step
        if candies_total > 0:
